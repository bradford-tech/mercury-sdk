...
T = TypeVar("T", bound="ApiV1ArInvoicesPaginatedResponsePage")


@_attrs_define
class ApiV1ArInvoicesPaginatedResponsePage:
    """Pagination information including cursors for navigating to next/previous pages

    Attributes:
        next_page (UUID | Unset): ID for the invoice.
        previous_page (UUID | Unset): ID for the invoice.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_v1_ar_invoices_paginated_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        api_v1_ar_invoices_paginated_response_page.additional_properties = d
        return api_v1_ar_invoices_paginated_response_page
