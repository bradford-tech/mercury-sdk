...
T = TypeVar("T", bound="AccountsPaginatedResponsePage")


@_attrs_define
class AccountsPaginatedResponsePage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        accounts_paginated_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        accounts_paginated_response_page.additional_properties = d
        return accounts_paginated_response_page
