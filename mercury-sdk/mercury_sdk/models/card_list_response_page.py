...
T = TypeVar("T", bound="CardListResponsePage")


@_attrs_define
class CardListResponsePage:
    """Pagination cursors for navigating to next/previous pages.

    Attributes:
        next_page (UUID | Unset): Unique identifier for a card
        previous_page (UUID | Unset): Unique identifier for a card
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        card_list_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        card_list_response_page.additional_properties = d
        return card_list_response_page
