...
T = TypeVar("T", bound="ApiEventsPaginatedResponsePage")


@_attrs_define
class ApiEventsPaginatedResponsePage:
    """Pagination information including cursors for navigating to next/previous pages

    Attributes:
        next_page (UUID | Unset): ID for the API event
        previous_page (UUID | Unset): ID for the API event
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_events_paginated_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        api_events_paginated_response_page.additional_properties = d
        return api_events_paginated_response_page
