...
T = TypeVar("T", bound="AddressWithoutName")


@_attrs_define
class AddressWithoutName:
    """
    Attributes:
        address1 (str):
        city (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        address_without_name.additional_properties = d
        return address_without_name
