...
T = TypeVar("T", bound="TreasuryAccountsPaginatedResponsePage")


@_attrs_define
class TreasuryAccountsPaginatedResponsePage:
    """Pagination information including cursors for navigating to next/previous pages

    Attributes:
        next_page (UUID | Unset): ID for a Mercury account.
        previous_page (UUID | Unset): ID for a Mercury account.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        treasury_accounts_paginated_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        treasury_accounts_paginated_response_page.additional_properties = d
        return treasury_accounts_paginated_response_page
