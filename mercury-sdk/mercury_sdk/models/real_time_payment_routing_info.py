...
T = TypeVar("T", bound="RealTimePaymentRoutingInfo")


@_attrs_define
class RealTimePaymentRoutingInfo:
    """
    Attributes:
        account_number (str):
        routing_number (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        real_time_payment_routing_info = cls(
        ...
        real_time_payment_routing_info.additional_properties = d
        return real_time_payment_routing_info
