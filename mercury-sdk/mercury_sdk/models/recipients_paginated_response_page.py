...
T = TypeVar("T", bound="RecipientsPaginatedResponsePage")


@_attrs_define
class RecipientsPaginatedResponsePage:
    """Pagination information including cursors for navigating to next/previous pages

    Attributes:
        next_page (UUID | Unset): ID for the recipient
        previous_page (UUID | Unset): ID for the recipient
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recipients_paginated_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        recipients_paginated_response_page.additional_properties = d
        return recipients_paginated_response_page
