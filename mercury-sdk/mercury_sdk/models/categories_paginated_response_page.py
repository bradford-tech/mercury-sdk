...
T = TypeVar("T", bound="CategoriesPaginatedResponsePage")


@_attrs_define
class CategoriesPaginatedResponsePage:
    """Pagination information including cursors for navigating to next/previous pages

    Attributes:
        next_page (UUID | Unset): ID for the category
        previous_page (UUID | Unset): ID for the category
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        categories_paginated_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        categories_paginated_response_page.additional_properties = d
        return categories_paginated_response_page
