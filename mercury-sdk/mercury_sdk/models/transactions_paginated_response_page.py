...
T = TypeVar("T", bound="TransactionsPaginatedResponsePage")


@_attrs_define
class TransactionsPaginatedResponsePage:
    """
    Attributes:
        next_page (UUID | Unset):  Example: 00000000-0000-0000-0000-000000000000.
        previous_page (UUID | Unset):  Example: 00000000-0000-0000-0000-000000000000.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transactions_paginated_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        transactions_paginated_response_page.additional_properties = d
        return transactions_paginated_response_page
