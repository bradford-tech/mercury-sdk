...
T = TypeVar("T", bound="TreasuryStatementsPaginatedResponsePage")


@_attrs_define
class TreasuryStatementsPaginatedResponsePage:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        treasury_statements_paginated_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        treasury_statements_paginated_response_page.additional_properties = d
        return treasury_statements_paginated_response_page
