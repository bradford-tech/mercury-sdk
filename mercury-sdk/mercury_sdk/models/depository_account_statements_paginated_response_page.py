...
T = TypeVar("T", bound="DepositoryAccountStatementsPaginatedResponsePage")


@_attrs_define
class DepositoryAccountStatementsPaginatedResponsePage:
    """
    Attributes:
        next_page (UUID | Unset): ID for the account statement
        previous_page (UUID | Unset): ID for the account statement
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        depository_account_statements_paginated_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        depository_account_statements_paginated_response_page.additional_properties = d
        return depository_account_statements_paginated_response_page
