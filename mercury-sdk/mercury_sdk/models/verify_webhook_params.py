...
T = TypeVar("T", bound="VerifyWebhookParams")
...
class VerifyWebhookParams:
    ...
    Attributes:
        event_type (None | Unset | WebhookEventType):  Optional event type to test. If not specified, defaults to
            transaction.created.
    """

    event_type: None | Unset | WebhookEventType = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        verify_webhook_params = cls(
            event_type=event_type,
        )

        verify_webhook_params.additional_properties = d
        return verify_webhook_params
