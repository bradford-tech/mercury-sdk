...
T = TypeVar("T", bound="MerchantsResponsePage")


@_attrs_define
class MerchantsResponsePage:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        merchants_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        merchants_response_page.additional_properties = d
        return merchants_response_page
