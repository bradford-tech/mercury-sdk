...
T = TypeVar("T", bound="ApiV1ArCustomerAddressInput")


@_attrs_define
class ApiV1ArCustomerAddressInput:
    ...
    Attributes:
        ...
        name (str):  The mailing name of the address.
        postal_code (str):  Postal or ZIP code.
        region (str):  Either a two-letter US state code i.e. "CA" for California or a free-form identification of a
            particular region worldwide.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_v1_ar_customer_address_input = cls(
            address1=address1,
            city=city,
            country=country,
            name=name,
        ...
        api_v1_ar_customer_address_input.additional_properties = d
        return api_v1_ar_customer_address_input
