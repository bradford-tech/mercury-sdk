...
T = TypeVar("T", bound="RecipientsAttachmentsPaginatedResponsePage")


@_attrs_define
class RecipientsAttachmentsPaginatedResponsePage:
    """Pagination information

    Attributes:
        next_page (UUID | Unset): ID for the recipient tax form attachment
        previous_page (UUID | Unset): ID for the recipient tax form attachment
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recipients_attachments_paginated_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        recipients_attachments_paginated_response_page.additional_properties = d
        return recipients_attachments_paginated_response_page
