...
from ..models.post_transaction_payment_method import PostTransactionPaymentMethod
...
T = TypeVar("T", bound="PostTransactionAPIRequest")


@_attrs_define
class PostTransactionAPIRequest:
    """
    Attributes:
        ...
        payment_method (PostTransactionPaymentMethod):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payment_method = PostTransactionPaymentMethod(d.pop("paymentMethod"))
        ...
        post_transaction_api_request = cls(
            amount=amount,
        ...
        post_transaction_api_request.additional_properties = d
        return post_transaction_api_request
