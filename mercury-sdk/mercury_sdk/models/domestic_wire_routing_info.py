...
T = TypeVar("T", bound="DomesticWireRoutingInfo")
...
class DomesticWireRoutingInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domestic_wire_routing_info = cls(
        ...
        domestic_wire_routing_info.additional_properties = d
        return domestic_wire_routing_info
