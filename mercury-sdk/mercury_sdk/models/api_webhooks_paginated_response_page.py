...
T = TypeVar("T", bound="ApiWebhooksPaginatedResponsePage")


@_attrs_define
class ApiWebhooksPaginatedResponsePage:
    """Pagination information including cursors for navigating to next/previous pages

    Attributes:
        next_page (UUID | Unset): ID for the webhook
        previous_page (UUID | Unset): ID for the webhook
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_webhooks_paginated_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        api_webhooks_paginated_response_page.additional_properties = d
        return api_webhooks_paginated_response_page
