...
T = TypeVar("T", bound="UsersPaginatedResponsePage")


@_attrs_define
class UsersPaginatedResponsePage:
    """Pagination information including cursors for navigating to next/previous pages

    Attributes:
        next_page (UUID | Unset): ID for the user
        previous_page (UUID | Unset): ID for the user
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_paginated_response_page = cls(
            next_page=next_page,
            previous_page=previous_page,
        )

        users_paginated_response_page.additional_properties = d
        return users_paginated_response_page
