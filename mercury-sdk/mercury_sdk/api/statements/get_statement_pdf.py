...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/statements/{statement_id}/pdf".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Download account statement PDF
     ...
     Downloads a PDF file for the specified account statement. The response includes a Content-
    Disposition header for proper file download handling. Returns binary PDF data.

    Args:
        statement_id (UUID): ID for the account statement
