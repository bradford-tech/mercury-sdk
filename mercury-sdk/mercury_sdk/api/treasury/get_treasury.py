...
from ...models.get_treasury_order import GetTreasuryOrder
from ...models.treasury_accounts_paginated_response import TreasuryAccountsPaginatedResponse
...
def _get_kwargs(
    *,
    ...
    order: GetTreasuryOrder | Unset = GetTreasuryOrder.ASC,
) -> dict[str, Any]:
...
) -> Any | TreasuryAccountsPaginatedResponse | None:
    if response.status_code == 200:
        response_200 = TreasuryAccountsPaginatedResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | TreasuryAccountsPaginatedResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Use cursor parameters (start_after, end_before) for pagination.
    ...
    Args:
        ...
        order (GetTreasuryOrder | Unset): Sort order. Can be 'asc' or 'desc'. Defaults to 'asc'
            Default: GetTreasuryOrder.ASC.
...
def sync(
    *,
    ...
    Returns:
        Any | TreasuryAccountsPaginatedResponse
    """
